export const MiniFooter = () => {
    return(
        <section className="items-center justify-between bg-black flex flex-row  px-40 py-20"> 
            <div className="font-bold text-[40px]">Get started for <span className="text-5xl font-bold bg-gradient-to-r from-pink-200 to-blue-200 bg-clip-text text-transparent">Free</span></div>
